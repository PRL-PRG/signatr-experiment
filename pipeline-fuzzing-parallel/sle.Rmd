...
ggplot(aes(x = reorder(fun_name, -all, sum), color = name)) +
    ...
    annotate("text", x = 2500, y = 2.5, label = "Fuzzing", size = 4, fontface = "bold") +
    annotate("text", x = 2500, y = -2.5, label = "Tracing", size = 4, fontface = "bold") +
